...
router.post("/", 
    [ //always put middleware(s) in the second position, in this case, we have two middlewares: auth, check
        auth, 
    ...
    async (req,res) => {
        ...
        //build profile object (to insert to the database)
        const profileFields = {};
        ...
        try{
            ...
            if(profile) {
                //if the user profile exsits, update the profile
...
//@access   private  //if it is private, we have access to the token
